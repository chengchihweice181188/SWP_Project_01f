    ...
    <body>
        <div class="navbar">
            ...
            <div class="navbar-items">
                <a class="nav-link item-txt" href="/Order">
                    <img class="nav-icon" src="/WebLogo/order.png">
                </a>
                <a class="nav-link item-txt" href="/Cart">
                    <img class="nav-icon" src="/WebLogo/cart.png">
                </a>
                <a class="nav-link item-txt" href="/Notifications">
                    <img class="nav-icon" src="/WebLogo/bell.png">
                </a>
                <a class="nav-link item-txt" href="Profile">
