...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .rate-btn:hover {
                background-color: #e66a00; /* Màu cam đậm hơn khi hover */
            }
            .view-btn{
                        ...
                        <div class="order-item-buttons">
                            <c:choose>
                                <c:when test="${order.order_status == 'Đã giao'}">
                                    <c:choose>
                                        <c:when test="${!order.feedbackExists}">
                                            <form action="CreateRating" method="GET">
                                                <input type="hidden" name="order_id" value="${order.order_id}">
                                                <button type="submit" class="rate-btn">Đánh giá</button>
                                            </form>
                                        </c:when>
                                        <c:otherwise>
                                            <form action="ViewRating" method="GET">
                                                <input type="hidden" name="order_id" value="${order.order_id}">
                                                <button type="submit" class="view-btn">Xem đánh giá</button>
                                            </form>
                                        </c:otherwise>
                                    </c:choose>
                                </c:when>
