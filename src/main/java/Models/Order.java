...
public class Order {
    ...
    private boolean feedbackExists;  // Thêm thuộc tính này


    // Getter và Setter cho feedbackExists
    ...
    public Order(int order_id, String order_note, double order_price, String order_status, Date order_date, int payment_status, String payment_method, int feedback_rating, String feedback_comment, int user_id, int staff_id, int voucher_id) {
        this.order_id = order_id;
        this.order_note = order_note;
        this.order_price = order_price;
        this.order_status = order_status;
