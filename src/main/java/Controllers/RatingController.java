 ...
 * @author tvhun
 */
@WebServlet(name = "RatingController", urlPatterns = {"/viewRatingList"})
        ...
        if (conn != null) {
            try {
                ...
                if (filter == null || "all".equals(filter)) {
                    ...
                    ratings = ratingDAO.getRatingsByDay();
                } else if ("week".equals(filter)) {
                    ratings = ratingDAO.getRatingsByWeek();
                } else if ("month".equals(filter)) {
                    ratings = ratingDAO.getRatingsByMonth();
                } else {
                    ratings = ratingDAO.getAllRatings();
                }

                request.setAttribute("ratings", ratings);
                request.getRequestDispatcher("viewRatingList.jsp").forward(request, response);
