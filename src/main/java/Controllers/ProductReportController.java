...
public class ProductReportController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Object[]> productReports;

        if ("weekly".equals(reportType)) {
            productReports = productDao.getWeeklyProductSalesReport();
        } else if ("monthly".equals(reportType)) {
            productReports = productDao.getMonthlyProductSalesReport();
        } else {
            productReports = productDao.getProductSalesReport(); // Default: all products
        }
